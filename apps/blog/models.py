...
class Comment(MPTTModel):
    ...
    status = models.CharField(choices=STATUS_OPTIONS, default='published', verbose_name="Статус поста", max_length=18)
    ...
    class Meta:
        """
        Сортировка, название модели в админ панели, таблица в БД
        """
