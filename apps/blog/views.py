...
def tr_handler404(request, exception):
    ...
    """
    return render(request, 'errors/error_page.html', status=404, context={"title": "Страница не найдена: 404",
...
def tr_handler500(request):
    ...
    """
    return render(request, 'errors/error_page.html', status=500, context={
...
def tr_handler403(request, exception):
    ...
    """
    return render(request, 'errors/error_page.html', status=403, context={
